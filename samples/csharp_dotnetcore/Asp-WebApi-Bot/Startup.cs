...
namespace Asp_WebApi_Bot2
{
    ...
    ";
            ...
            // register endpoint for anyone who wants to get it via DI
            services.AddSingleton(endpoint ?? throw new InvalidOperationException($"The .bot file does not contain an endpoint."));
            ...
            // register the bot so our controller can pick it up and use it
